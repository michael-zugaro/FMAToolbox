...
%                   (default = [3 5])
%     'pad'         FFT padding (see help for <a href="matlab:help mtspectrumpt">mtspectrumc</a>) (default = 0)
%     'error'       error type (see help for <a href="matlab:help mtspectrumpt">mtspectrumc</a>) (default = [1 0.95])
